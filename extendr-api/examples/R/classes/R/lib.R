...
# It is the intention that this will be generated by the rust #[extendr] in due course.
setClass("Animal", representation( pointer = "externalptr" ) )

setMethod("$", "Animal", function(x, name) {
    function(...) .Call(paste0("wrap__Animal__", name), x@pointer, ...)
} )

setMethod("initialize", "Animal", function(.Object, ...) {
    .Object@pointer <- .Call("wrap__Animal__new", ...)
    .Object
} )